...
# Unit tests for FormAPI::DataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DataRequest' do
  before do
    # run before each test
    @instance = FormAPI::DataRequest.new
  end
  ...
  describe 'test an instance of DataRequest' do
    it 'should create an instance of DataRequest' do
      expect(@instance).to be_instance_of(FormAPI::DataRequest)
    end
  end
