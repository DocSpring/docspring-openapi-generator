...
FormAPI - JavaScript client for @formapi/formapi
...
You should now be able to `require('@formapi/formapi')` in javascript files from the directory you ran the last 
command above from.
