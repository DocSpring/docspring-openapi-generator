...
${nuget_cmd} install src/FormApi.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/FormApi.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/FormApi.Client.dll \
-recurse:'src/FormApi.Client/*.cs' \
-doc:bin/FormApi.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/FormApi.Client.dll was created successfully"
fi
