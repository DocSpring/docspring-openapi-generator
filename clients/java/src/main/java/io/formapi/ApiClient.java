...
import io.formapi.auth.HttpBasicAuth;
import io.formapi.auth.ApiKeyAuth;
import io.formapi.auth.OAuth;
import io.formapi.auth.OAuth.AccessTokenListener;
import io.formapi.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://app.formapi.io/api/v1";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
